...
import SpotPage from '../../src/views/SpotPage.vue'
...
jest.spyOn(fetch, 'get').mockResolvedValue(spotData)
describe('LanguageSelector.vue', () => {
    it('renders all six images', () => {
        const wrapper = shallowMount(SpotPage, {
            props: { id: "aceb30d9-8a56-4073-a863-7340a67f32c6", language:language}
        })
